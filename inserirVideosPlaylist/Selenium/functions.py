...
# Recebe como parâmetros o navegador (driver), a seção rolável e o intervalo entre rolagens (2s por padrão)
    ...
    screen_height = driver.execute_script(f"return {scrollable_section_selector}.clientHeight;") # altura da tela
    ...
    while current_position < scroll_height:
        driver.execute_script(f"window.scrollBy(0, arguments);", screen_height) # Rola a página para baixo pela altura da tela
